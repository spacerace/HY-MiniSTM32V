...
It shows how to use Keil's printf family of functions in conjunction with USART1.

RXNE interrupt is installed, it just sends back what is received on USART1.
